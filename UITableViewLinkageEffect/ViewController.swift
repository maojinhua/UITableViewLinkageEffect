...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    //var WZB:WZBLinkageTableView = WZBLinkageTableView();
    var leftTableView:UITableView?;
    var rightTableView:UITableView?;
    var datas = ["快餐","电影","聚会","出游","健身","旅游","运动","美食"];
    override func viewDidLoad() {
        super.viewDidLoad()
        self.setBaseTableView();
        //WZB.setBaseTableView();
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let ID2 = "cellId";
        let cell:UITableViewCell = UITableViewCell(style: .Default, reuseIdentifier: ID2);
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        {// 如果点击的是右边的tableView，不做任何处理
            ...
            self.rightTableView!.selectRowAtIndexPath(path, animated: true, scrollPosition: UITableViewScrollPosition.Top);
        }
    }
